						...
						<div class="mb-4 flex items-center gap-3">
							...
							<div class="flex-1">
								<div class="flex items-center gap-2">
									...
									<HelpTooltip
										content="Comparison of local labor metrics against Philippine national averages. Data sources include PSA Labor Force Survey and World Bank."
										class="text-blue-700"
									/>
								</div>
								<p class="text-xs text-muted-foreground">Sitio vs. Philippine National Averages</p>
							</div>
						</div>
