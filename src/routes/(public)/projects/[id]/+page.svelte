...
>
	...
	{:else if project}
		...
		<!-- Hero Header -->
		<div
			class="relative border-b bg-linear-to-br from-primary/5 via-primary/3 to-transparent dark:from-primary/10 dark:via-primary/5"
		>
			<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
				<div class="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
					...
					<Button variant="outline" class="shrink-0" onclick={() => history.back()}>
		...
		<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
			...
			<!-- Footer Metadata -->
			<div class="mt-8 rounded-lg border bg-slate-50/50 px-6 py-4 dark:bg-slate-900/50">
				<div
